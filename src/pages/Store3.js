/* Add these CSS styles to your Store.css file for typing animations */
  ...
  */import React, { useState, useEffect, useRef } from 'react';
  ...
  import profileImage from '../components/Images/Profile3.png';
  // Import special product image
  import keyboardImage from '../components/Images/img1.jpg';
  // Import video
  import bgVideo from '../components/Images/bg3.mp4';
  ...
  function Store() {
    ...
    const [comments, setComments] = useState([
      {
        id: 2,
        username: "Customer",
        text: "sizing runs a bit small imo. I'm usually an M but had to exchange for L. quality is top tho"
      },
      {
        id: 3,
        username: "Customer",
        text: "The embroidery on the back is insane?? like, genuinely art. pls drop more designs like this"
      },
      {
        id: 4,
        username: "Customer",
        text: "Ordered the celestial windbreaker—took 8 days to arrive but damn it's worth it. Got compliments at the arcade lol"
      },
      {
        id: 5,
        username: "Customer",
        text: "not gonna lie I bought this just bc the name is Angel's Sword 😂 but the jacket legit slaps"
      },
      {
        id: 6,
        username: "Customer",
        text: "thread on the sleeve came loose after one wash :/ can u help?"
      },
      {
        id: 7,
        username: "Customer",
        text: "Feels like something Cloud would wear tbh. Keep making these RPG-core drops"
      },
      {
        id: 8,
        username: "Customer",
        text: "this brand is for the chosen ones only lmao. seriously tho, love the attention to detail"
      }
    ]);
    ...
    useEffect(() => {
      document.title = "Angel's Sword – Storia";
    ...
    useEffect(() => {
      ...
      setTimeout(() => {
        ...
        const initialMessage = "Welcome, traveler. I am Sylra, and alongside my brother Thalen, we present Angel’s Sword — attire born of myth and memory, inspired by the realms we once wandered. Tell me, which tale shall your threads whisper today?";
    ...
    return (
      <>
        ...
        <div className="top-banner">
          <h1 className="banner-title">Storia x Angel's Sword</h1>
                        ...
                        >
                          {message.sender === 'agent' ? (
                            <div className="message-with-avatar">
                              ...
                              <div>
                                <div className="agent-name">Sylra</div>
                                {message.hasHtml ? (
                                  <div 
