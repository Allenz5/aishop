/* Add these CSS styles to your Store.css file for typing animations */
  ...
  */import React, { useState, useEffect, useRef } from 'react';
  ...
  import profileImage from '../components/Images/Profile2.png';
  // Import special product image
  import keyboardImage from '../components/Images/img1.jpg';
  // Import video
  import bgVideo from '../components/Images/bg2.mp4';
  ...
  function Store() {
    ...
    const [comments, setComments] = useState([
      {
        id: 1,
        username: "Customer",
        text: "Loved the red blend! Super smooth and just the right amount of fruity notes. Will def buy again"
      },
      {
        id: 2,
        username: "Customer",
        text: "shipping took a bit longer than expected, but the rose was totally worth it in the end",
        reply: {
          username: "Admin",
          text: "Thanks for your patience and kind words! We're working to improve shipping times, especially during peak seasons."
        }
      },
      {
        id: 3,
        username: "Customer",
        text: "Honestly wasn't sure what to expect but really impressed. Packaging is sleek af, and the wine tastes way more expensive than it is."
      },
      {
        id: 4,
        username: "Customer",
        text: "Had a small leak in one of the bottles :/ not ideal but customer support was quick to send a new one so props for that.",
        reply: {
          username: "Admin",
          text: "We're really sorry about the leak! Glad our team could resolve it quickly. Thanks for understanding"
        }
      },
      {
        id: 5,
        username: "Customer",
        text: "Great for dinner parties, everyone kept asking where I got it from haha"
      },
      {
        id: 6,
        username: "Customer",
        text: "The white is ok, a bit too sweet for my taste tho. Would love to see a dryer option!"
      },
      {
        id: 7,
        username: "Customer",
        text: "first time trying this brand, and I’m hooked. already ordered another box 😅"
      }
    ]);
    ...
    useEffect(() => {
      ...
      setTimeout(() => {
        ...
        const initialMessage = "Welcome, friend. I’m Mr. Vino — proud grower for Gratsi. Around here, we let the grapes speak for themselves. Care to find the bottle that suits your story?";
    ...
    return (
      <>
        ...
        <div className="top-banner">
          <h1 className="banner-title">Storia x Gratsi</h1>
                        ...
                        >
                          {message.sender === 'agent' ? (
                            <div className="message-with-avatar">
                              ...
                              <div>
                                <div className="agent-name">Mr. Vino</div>
                                {message.hasHtml ? (
                                  <div 
